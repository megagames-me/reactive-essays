...
const People: FC<PeopleProps> = ({ rows, columns, people, percentage, hasIcon, darkTheme }: PeopleProps) => {
			...
			{list.map((highlight: boolean, index: number) => {
				return (
					<div key={index} style={{
						...
						{ hasIcon ? (<svg height="17.5px" width="17.5px" viewBox="0 0 24 24" fill={highlight ?  "#991B1B" : darkTheme? "#71717A" : "#A1A1AA"}>
